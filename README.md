...
- View detailed hotel information including:
  - Address
  - Amenities
  - Photos
...
- Update hotel details and manage availability
- Users can instantly see added hotels on the platform
...
- **React 19** (client-side state & components)
- **Tailwind CSS + DaisyUI** (responsive design & prebuilt UI components)
...
- **Firebase Authentication** (user login, Google login)
- **Firebase Firestore** (hotel and booking data storage)
- **Firebase Storage** (image uploads for hotels and rooms)

**Data Fetching & APIs**

- **Axios** (HTTP requests to backend / Firebase APIs)

**Deployment / Hosting**

- **Vercel** (production hosting for Next.js project)
